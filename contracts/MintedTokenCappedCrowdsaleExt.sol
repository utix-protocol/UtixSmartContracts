...
contract MintedTokenCappedCrowdsaleExt is CrowdsaleExt {
  ...
  ) public CrowdsaleExt(_name, _token, _pricingStrategy, _multisigWallet, _start, _end, _minimumFundingGoal, _isUpdatable, _isWhiteListed, _tokenVestingAddress) {
  ...
  function isBreakingInvestorCap(address addr, uint weiAmount) public constant returns (bool limitBroken) {
